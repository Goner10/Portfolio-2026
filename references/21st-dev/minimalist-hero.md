# Minimalist Hero — 21st.dev

Purpose:
Reference for the main portfolio hero.

Keep:
- Three-column editorial layout
- Portrait + large background circle
- Large typography
- Framer Motion entrance sequence
- Social + location framing
